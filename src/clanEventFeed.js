...
export function clanUpcomingEvents(ordinary, bosses, sieges, now = new Date()) {
...
export function publishClanEventSources(ordinary, bosses, sieges) {
  sources = {ordinary, bosses, sieges};
  const next = JSON.stringify(clanUpcomingEvents(ordinary,bosses,sieges));
