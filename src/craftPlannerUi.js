...
function renderProjectCard(project, workspace) {
  ...
  return `
    <article class="craft-project-card ${project.status === 'active' ? 'is-active' : 'is-paused'}" data-craft-project="${escapeHtml(project.id)}">
