...
export function installMemberAuth(supabase) {
  ...
  css.textContent = `
    ...
    .member-zone-side{display:flex;flex-direction:column;padding:22px 18px;border-right:1px solid #392c18;background:linear-gradient(180deg,#0d1212,#070a0a)}.member-zone-side img{width:100px;height:82px;object-fit:contain;margin:0 auto 8px}.member-zone-side>.member-kicker{text-align:center}.member-zone-side h3{text-align:center;margin:5px 0 22px;color:#f0cf7e;font:700 22px Georgia}.zone-nav{display:flex;gap:11px;align-items:center;margin:2px 0;padding:10px 11px;border:1px solid transparent;background:transparent;color:#999389;text-align:left;font-weight:800;cursor:pointer}.zone-nav:hover,.zone-nav.active{border-color:#665026;background:linear-gradient(90deg,#3a2812,#18140d);color:#efc56a}.zone-nav-icon{position:relative;display:block;flex:0 0 28px;width:28px;height:28px;border:1px solid #4b4232;background-color:#10110f;background-repeat:no-repeat;background-position:center;background-size:24px 24px;box-shadow:inset 0 0 8px #000,0 1px 0 #78674733}.zone-nav-icon:after{content:"";position:absolute;inset:2px;border:1px solid rgba(180,153,99,.12);pointer-events:none}.zone-nav:hover .zone-nav-icon,.zone-nav.active .zone-nav-icon{border-color:#a07835;box-shadow:inset 0 0 8px #000,0 0 9px rgba(218,166,66,.28)}.zone-nav[data-zone-view="home"] .zone-nav-icon{background-image:url("/assets/interlude/icons/etc_jewel_box_i00.png")}.zone-nav[data-zone-view="events"] .zone-nav-icon{background-image:url("/assets/interlude/icons/etc_recipe_black_i00.png")}.zone-nav[data-zone-view="signups"] .zone-nav-icon{background-image:url("/assets/interlude/icons/etc_crystal_gold_i00.png")}.zone-nav[data-zone-view="announcements"] .zone-nav-icon{background-image:url("/assets/interlude/icons/etc_letter_red_i00.png")}.zone-nav[data-zone-view="profile"] .zone-nav-icon{background-image:url("/assets/interlude/icons/armor_helmet_i02.png")}.zone-nav[data-zone-view="recruitment"] .zone-nav-icon{background-image:url("/assets/interlude/icons/etc_pouch_yellow_i00.png")}.zone-nav[data-zone-view="content-editor"] .zone-nav-icon{background-image:url("/assets/interlude/icons/weapon_hammer_of_destroyer_i00.png")}.zone-nav[data-zone-view="members"] .zone-nav-icon{background-image:url("/assets/interlude/icons/shield_dark_crystal_shield_i02.png")}.zone-nav[data-zone-view="needed-rb"] .zone-nav-icon{background-image:url("/assets/interlude/icons/weapon_dark_legions_edge_i00.png")}.zone-nav[data-zone-view="craft"] .zone-nav-icon{background-image:url("/assets/interlude/icons/etc_blacksmiths_frame_i00.png")}.zone-nav[data-zone-view="attendance"] .zone-nav-icon{background-image:url("/assets/interlude/icons/etc_crystal_ball_white_i00.png")}.zone-side-spacer{flex:1}.zone-logout{padding:14px;border:1px solid #9a722f;background:#17130d;color:#e2b85f;font-weight:900;cursor:pointer}.zone-side-foot{padding:18px 10px 4px;margin-top:14px;border-top:1px solid #302719;color:#777168}.zone-side-foot small,.zone-side-foot b{display:block;font-size:9px;letter-spacing:.14em}
    ...
    @media(max-width:900px){#memberZoneLayer{padding:5px}.member-zone-box{grid-template-columns:1fr;width:100%;height:calc(100vh - 10px)}.member-zone-side{display:grid;grid-template-columns:repeat(4,1fr);gap:3px;padding:9px;border-right:0;border-bottom:1px solid #342918}.member-zone-side img,.member-zone-side>.member-kicker,.member-zone-side h3,.zone-side-spacer,.zone-logout,.zone-side-foot{display:none}.zone-nav{justify-content:center;gap:5px;padding:7px 4px;font-size:10px}.zone-nav-icon{flex-basis:22px;width:22px;height:22px;background-size:19px 19px}.member-zone-main{padding:18px 12px}.member-zone-grid{grid-template-columns:1fr 1fr}.zone-columns,.zone-bottom{grid-template-columns:1fr}.member-zone-main>header h2{font-size:25px}}
  `;
