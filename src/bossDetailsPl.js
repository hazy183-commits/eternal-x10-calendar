...
function ensureStyles() {
  ...
  style.textContent = `
    ...
    .boss-info-pl-kind{display:inline-block;margin:9px 0 18px;padding:8px 11px;border:1px solid #98712f;color:#f0c86f;background:#21180c;font-size:10px;font-weight:900;letter-spacing:.1em;text-transform:uppercase}
    .boss-info-pl-text{margin:0;color:#d6cec2;font-size:15px;line-height:1.65}
    .boss-info-pl-meta{display:grid;grid-template-columns:auto 1fr;gap:8px 15px;margin-top:20px;padding-top:17px;border-top:1px solid #514127;font-size:13px}.boss-info-pl-meta b{color:#e1b75f}.boss-info-pl-meta span{color:#d0c8bc}
    .boss-info-pl-server{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px;margin-top:20px}.boss-info-pl-server div{padding:12px;border:1px solid #745724;background:linear-gradient(180deg,#20170b,#10110e)}.boss-info-pl-server small{display:block;color:#b8a27b;font-size:10px;font-weight:700;text-transform:uppercase;line-height:1.35}.boss-info-pl-server b{display:block;margin-top:5px;color:#f2cf79;font-size:15px;line-height:1.3}
    .boss-info-pl-section{margin-top:22px;padding-top:18px;border-top:1px solid #514127}.boss-info-pl-section h4{margin:0 0 12px;color:#e6bb63;font:800 13px Inter,sans-serif;letter-spacing:.13em;text-transform:uppercase}
    .boss-info-pl-stats{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px}.boss-info-pl-stat{padding:11px 12px;border:1px solid #514329;background:#0d1110}.boss-info-pl-stat span{display:block;color:#aaa195;font-size:10px;font-weight:800;text-transform:uppercase}.boss-info-pl-stat b{display:block;margin-top:5px;color:#fff1dc;font-size:16px;font-variant-numeric:tabular-nums}
    .boss-info-pl-drop-wrap{max-height:330px;overflow:auto;border:1px solid #4c402d;background:#090c0b;scrollbar-color:#aa813d #171815;scrollbar-width:thin}.boss-info-pl-drop-head,.boss-info-pl-drop-row{display:grid;grid-template-columns:minmax(0,1fr) 82px 100px;gap:10px;align-items:center;padding:10px 12px}.boss-info-pl-drop-head{position:sticky;top:0;z-index:2;background:#1b160e;border-bottom:1px solid #765829;color:#d7b56e;font-size:10px;font-weight:900;text-transform:uppercase;letter-spacing:.08em}.boss-info-pl-drop-row{border-bottom:1px solid #30291e;color:#ddd4c7;font-size:12px;line-height:1.35}.boss-info-pl-drop-row:hover{background:#17150f}.boss-info-pl-drop-row:last-child{border-bottom:0}.boss-info-pl-drop-row b{color:#f0e8dc;font-weight:700}.boss-info-pl-drop-row b small{color:#d2b46f;font-size:10px}.boss-info-pl-drop-row .chance,.boss-info-pl-drop-row .qty{text-align:right;color:#d8d0c3;font-variant-numeric:tabular-nums}.boss-info-pl-drop-row.epic{background:linear-gradient(90deg,#4a301466,transparent);box-shadow:inset 4px 0 #d69d38}.boss-info-pl-drop-row.epic b,.boss-info-pl-drop-row.epic .chance{color:#ffd477}
