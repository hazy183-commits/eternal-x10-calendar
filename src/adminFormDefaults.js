export const BOSS_PRESETS = Object.freeze({
  'Queen Ant': Object.freeze({ slug: 'queen-ant', location: 'Queen Ant Nest', type: 'Epic RB' }),
  Core: Object.freeze({ slug: 'core', location: 'Core Chamber', type: 'Epic RB' }),
  Orfen: Object.freeze({ slug: 'orfen', location: 'Sea of Spores', type: 'Epic RB' }),
  Baium: Object.freeze({ slug: 'baium', location: "Baium's Tower", type: 'Epic RB' }),
  Zaken: Object.freeze({ slug: 'zaken', location: "Devil's Isle", type: 'Epic RB' }),
